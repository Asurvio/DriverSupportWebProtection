...
export const FILTERS_TRANSLATIONS = {
    ...
    [FILTER_RULESET[RulesetType.RULESET_14].id]: {
        ...
        description: translator.getMessage(
            'options_block_annoyances_option_desc',
        ),
    },
    [FILTER_RULESET[RulesetType.RULESET_3].id]: {
        ...
        description: translator.getMessage(
            'options_block_trackers_option_desc',
        ),
    },
    [FILTER_RULESET[RulesetType.RULESET_4].id]: {
        ...
        description: translator.getMessage(
            'options_block_social_widgets_option_desc',
        ),
    },
};
...
export const Settings = observer(() => {
    ...
    const OPTIONS = {
        ...
        CUSTOM_FILTERS: {
            ...
            messageDesc: translator.getMessage(
                'options_custom_filters_option_desc',
            ),
            to: '/customfilters',
        },
        USER_RULES: {
            ...
            messageDesc: translator.getMessage(
                'options_user_rules_option_desc',
            ),
            // TODO: make enum
            to: '/userrules',
        },
    ...
    return (
        <>
            <Section title={translator.getMessage('options_settings_title')}>
